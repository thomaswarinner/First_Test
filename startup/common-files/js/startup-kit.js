...
/* Header 2*/
startupKit.uiKitHeader.header60 = function() {
    startupKit.uiKitHeader._inFixedMode('.header-60');
};
...
/* Header 10*/
    ...
    $('.header-10 .navbar .nav li a span').on('click', function() {
        $.scrollTo($('.content-26').next(), {
            axis : 'y',
            duration : 1300
        });
        return false;
...
/* Header 99*/
startupKit.uiKitHeader.header99 = function() {
    startupKit.uiKitHeader._inFixedMode('.header-99');
};
...
startupKit.uiKitHeader.header23 = function() {
    ...
    $('header-10 .mask, header-10 .popup-video').not('pre .mask, pre .popup-video').detach();
